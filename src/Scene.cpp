...
std::vector<std::shared_ptr<Object>> Scene::InitObjects()
{
	...
	std::shared_ptr<TriangleMesh> triMesh = std::make_shared<TriangleMesh>("obj/dragon.obj");
...
std::vector<std::shared_ptr<Light>> Scene::InitLightSources()
{
	...
	std::shared_ptr<Light> light1 = std::make_shared<Light>(light1Position, Color(255), 2, Light::POINT);
