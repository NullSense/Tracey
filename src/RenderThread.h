...
inline RenderThread::RenderThread()
{
}
...
inline FPType RenderThread::Fresnel(const Vector3d &sceneDirection, const Vector3d &normal, const FPType ior) const
{
	FPType kr;
...
inline Ray RenderThread::GetReflectionRay(const Vector3d &normal, const Vector3d &sceneDirection, const Vector3d &position)
{
...
inline Vector3d RenderThread::GetRefraction(const Vector3d &incident, const Vector3d &normal, const FPType ior) const
{
...
inline Color RenderThread::GetReflections(const Vector3d &position, const Vector3d &sceneDirection, const std::vector<std::shared_ptr<Object>> &sceneObjects,
	const int indexOfClosestObject, const std::vector<std::shared_ptr<Light>> &lightSources, int depth)
{
...
inline Color RenderThread::GetRefractions(const Vector3d &position, const Vector3d &dir, const std::vector<std::shared_ptr<Object>> &sceneObjects,
	const int &indexOfClosestObject, const std::vector<std::shared_ptr<Light>> &lightSources, int depth)
{
...
inline Color RenderThread::Trace(const Vector3d &intersection, const Vector3d &direction, const std::vector<std::shared_ptr<Object>> &sceneObjects, const int indexOfClosestObject,
...
inline int RenderThread::ClosestObjectIndex(const std::vector<FPType> &intersections)
{
...
inline void RenderThread::Render(const unsigned x, const unsigned y, const Color tempColor[]) const
{
...
inline void RenderThread::EvaluateIntersections(const FPType xCamOffset, const FPType yCamOffset, const unsigned aaIndex, Color tempColor[], const Matrix44f &cameraToWorld,
...
inline void RenderThread::LaunchThread(const unsigned start, const unsigned end, std::shared_ptr<bitmap_image> image)
{
	image1 = image;
